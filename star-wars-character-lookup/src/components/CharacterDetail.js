...
const CharacterDetail = ({ characterUrl, onBackClick }) => {
  ...
  return (
    <div className="character-detail">
      ...
      {additionalInfo.films.length > 0 && <h3>Films</h3>}
      <ul>
      ...
      {additionalInfo.species.length > 0 && <h3>Species</h3>}
      <ul>
      ...
      {additionalInfo.starships.length > 0 && <h3>Starships</h3>}
      <ul>
      ...
      {additionalInfo.vehicles.length > 0 && <h3>Vehicles</h3>}
      <ul>
